...
return [
    ...
    'system_prompt' => env('LARAGREP_SYSTEM_PROMPT', 'Você é um assistente que recebe perguntas em linguagem natural e responde apenas com JSON contendo uma consulta SQL SELECT segura e os respectivos bindings.'),
